...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Receipt.user'
        db.delete_column('receipts_receipt', 'user_id')

        # Adding field 'Receipt.member'
        db.add_column('receipts_receipt', 'member',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.Member'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Receipt.user'
        db.add_column('receipts_receipt', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Receipt.member'
        db.delete_column('receipts_receipt', 'member_id')
    ...
    models = {
        ...
        'receipts.receipt': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['members.Member']", 'null': 'True', 'blank': 'True'}),
